...
import 'package:soglom_ayol_3_progect/payment/pinput.dart';
    ...
    return Scaffold(
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset('assets/logo/card.png',width: 48,height: 30,alignment: Alignment.bottomLeft,),
                      const SizedBox(
                        height: 28,
                      ),
      ...
      bottomNavigationBar: InkWell(
        onTap: () {
          Navigator.push(
            context,
            CupertinoPageRoute(builder: (context) => PinPut()),
          );
        },
        child: Container(
          height: 100,
